...
public class ListSubmit extends Fragment implements ListSubmitAdapter.Callback {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_list_submit, null);
    ...
    public void onResume() {
        super.onResume();
        progressBar = getActivity().findViewById(R.id.progressLoad);
        imageNoData = getActivity().findViewById(R.id.imageNoDataSubmit);
    ...
    private  void  readData(){
        Query query = reference.child("BorrowBooks").orderByChild("status").equalTo(Status.Borrowing+"");
