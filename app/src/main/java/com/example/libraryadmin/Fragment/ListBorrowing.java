...
public class ListBorrowing extends Fragment implements ListSubmitAdapter.Callback {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_borrowing, null);
    ...
    private  void  setupViews(){
        progressBar = getActivity().findViewById(R.id.progressLoadBorrrowed);
        imageNoData = getActivity().findViewById(R.id.imageNoDataBorrowed);
        recyclerView = view.findViewById(R.id.recyclerListBorrowed);
        borrowDetails = new ArrayList<>();
        readData();
    }
    private  void  readData(){
        Query query = reference.child("BorrowBooks").orderByChild("status").equalTo(Status.Borrowed+"");
