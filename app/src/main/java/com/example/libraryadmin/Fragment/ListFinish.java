...
public class ListFinish extends Fragment implements ListSubmitAdapter.Callback {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_list_finish, null);
    ...
    private  void  setupViews(){
        progressBar = getActivity().findViewById(R.id.progressLoadFinish);
        imageNoData = getActivity().findViewById(R.id.imageNoDataFinish);
        recyclerView = view.findViewById(R.id.recyclerListFinish);
        borrowDetails = new ArrayList<>();
        readData();
    }
    private  void  readData(){
        Query query = reference.child("BorrowBooks").orderByChild("status").equalTo(Status.Finish+"");
    ...
    public void onClickItem(BorrowDetail key) {
        ...
        intent.putExtra("KEY", key+"-finish");
